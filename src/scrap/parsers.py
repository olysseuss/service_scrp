...
def work_ua(url, id_city=None, id_language=None):
    jobs = []
    errors = []
            ...
            if main_div:
                ...
                for div in div_list:
                    ...
                    jobs.append({'title': title.text, 'url': domain + href, 'description': content, 'company': company,
                                 'id_city_id': id_city, 'id_language_id': id_language})
            else:
...
def rabota_ua(url, id_city=None, id_language=None):
    jobs = []
    errors = []
...
def dou_ua(url, id_city=None, id_language=None):
    jobs = []
    errors = []
...
def djinni_co(url, id_city=None, id_language=None):
    jobs = []
    errors = []
